...
import com.example.demo.service.validation.UserValidator;
...
/**
 * Класс UserController является контроллером REST, который предоставляет API для работы с пользователями.
 * */
