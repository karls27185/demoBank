...
/**
 * Класс CustomAuthenticationSuccessHandler реализует интерфейс AuthenticationSuccessHandler и используется для обработки успешного входа пользователя в систему.
 * */
